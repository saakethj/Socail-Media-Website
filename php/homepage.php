...
<body>
  ...
  <div class="feed">
    ...
    <div class="tweetBox">
      <form action="account.php" method="post">
        ...
        <!-- <input type="file" id="myFile" name="filename" class="tweetBox__tweetButton"> -->
    ...
    <!-- post starts -->
    <div class="tagembed-container" style="margin:0 auto; width:620px;height:700%;overflow: auto;">
      <div class="tagembed-socialwall" data-wall-id="80103" view-url="https://widget.tagembed.com/80103"> </div>
      <script src="//widget.tagembed.com/embed.min.js" type="text/javascript"></script>
    </div>
    <div class="post">
      <div class="post__avatar">
        <img src="../images/feed dp/saaketh jella.jpg" alt="" />
      </div>
      ...
      <div class="post__body">
        <div class="post__header">
          ...
          <div class="post__headerDescription">
            <p><span class="highlight_words">#Neural networks</span>, also known as artificial neural networks (ANNs) or
              simulated neural networks (SNNs), are a subset of <span class="highlight_words">#machine learning</span>
              and are at the heart of deep learning algorithms. Their name and structure are inspired by the human
              brain, mimicking the way that biological neurons signal to one another.</p>
          </div>
        </div>
        <img src="../images/feed photos/neural-networks.jpg" alt="" />
    ...
    <div class="post">
      <div class="post__avatar">
        <img src="../images/feed dp/avengers.jpg" alt="" />
      </div>
      ...
      <div class="post__body">
        ...
        <img src="../images/feed photos/avengers.jpg" alt="" />
        <div class="post__footer">
          <span class="material-icons"> repeat </span>
          <span class="material-icons"> favorite_border </span>
          <span class="material-icons"> publish </span>
    ...
    <div class="post">
      <div class="post__avatar">
        <img src="../images/feed dp/hughie.jpg" alt="" />
      </div>
        ...
        <div class="post__header">
          <div class="post__headerText">
            <h3>
              Peter Hughie
              <span class="post__headerSpecial"><span class="material-icons post__badge"> verified
                </span>@Peter_2022</span>
            </h3>
          </div>
          <div class="post__headerDescription">
            <p><span class="highlight_words">Keanu Reeves</span> told Extra that he would love to play an older, wisened
              <span class="highlight_words">@Batman</span> someday: “It’s always been a dream, but Pattinson’s Batman
              right now. He’s doing awesome, but maybe down the road when they need an older Batman.”
            </p>
          </div>
        </div>
        <!-- <img
    ...
    <div class="post">
      <div class="post__avatar">
        <img src="../images/feed dp/butcher.jpg" alt="" />
      </div>
      ...
      <div class="post__body">
        ...
        <img src="../images/feed photos/car.jpg" alt="" />
        <div class="post__footer">
          <span class="material-icons"> repeat </span>
          <span class="material-icons"> favorite_border </span>
          <span class="material-icons"> publish </span>
    ...
    <div class="post">
      <div class="post__avatar">
        <img src="../images/feed dp/st.jpg" alt="" />
      </div>
    ...
    <div class="post">
      <div class="post__avatar">
        <img src="../images/feed dp/frenchie.jpg" alt="" />
      </div>
      ...
      <div class="post__body">
        ...
        <img src="../images/feed photos/the boys.jpg" alt="" />
        <div class="post__footer">
          <span class="material-icons"> repeat </span>
          <span class="material-icons"> favorite_border </span>
          <span class="material-icons"> publish </span>
  ...
  <div class="widgets">
    ...
    <div class="widgets__widgetContainer">
      ...
      <p class="trending_content">The first trailer for ‘BLACK PANTHER: WAKANDA FOREVER’ received 172 million views in
        its first 24 hours</p>
      <br>
